...
function default_menu_fallback() {
    ...
    echo '<li><a href="' . home_url('/category/movies/') . '">Movies</a></li>';
    echo '<li><a href="' . home_url('/category/series/') . '">Series</a></li>';
    echo '</ul>';
}
...
function mobile_menu_fallback() {
    ...
    echo '<li><a href="' . home_url() . '">Home</a></li>';
    echo '<li><a href="' . home_url('/category/bangla-movies/') . '">Bangla Movies</a></li>';
    echo '<li><a href="' . home_url('/category/hindi-movies/') . '">Hindi Movies</a></li>';
    echo '<li><a href="' . home_url('/category/english-movies/') . '">English Movies</a></li>';
    echo '<li><a href="' . home_url('/category/animated-movies/') . '">Animated Movies</a></li>';
    echo '<li><a href="' . home_url('/category/series/') . '">Series</a></li>';
    echo '<li><a href="' . home_url('/category/k-drama/') . '">K-Drama</a></li>';
    echo '<li><a href="' . home_url('/category/c-drama/') . '">C-Drama</a></li>';
    echo '<li><a href="' . home_url('/category/bangla-web-series/') . '">Bangla Web Series</a></li>';
    echo '<li><a href="' . home_url('/category/anime-series/') . '">Anime Series</a></li>';
    echo '</ul>';
}
?>
