    ...
    <div class="container">
      ...
      <div class="col-md-12">
        ...
        ?>
          ...
          <?php endif; ?>
                <?php $entertainment_media_footer_settings = get_theme_mod( 'entertainment_media_footer_social_links_settings' ); ?>
                <?php if ( is_array($entertainment_media_footer_settings) || is_object($entertainment_media_footer_settings) ){ ?>
                        <?php foreach( $entertainment_media_footer_settings as $entertainment_media_footer_setting ) { ?>
                        <a class="social-links" href="<?php echo esc_url( $entertainment_media_footer_setting['link_url'] ); ?>">
                            <i class="<?php echo esc_attr( $entertainment_media_footer_setting['link_text'] ); ?> me-3"></i>
                        </a>
                    <?php } ?>
                <?php } ?>
        </p>
