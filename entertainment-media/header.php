...
<?php if(get_theme_mod('entertainment_media_site_loader',false)!= ''){ ?>
    <?php if(get_theme_mod( 'entertainment_media_preloader_type','four-way-loader') == 'four-way-loader'){ ?>
	    <div class="cssloader">
	    	<div class="sh1"></div>
	    	<div class="sh2"></div>
	    	<h1 class="lt"><?php esc_html_e( 'loading',  'entertainment-media' ); ?></h1>
	    </div>
    <?php }else if(get_theme_mod( 'entertainment_media_preloader_type') == 'cube-loader') {?>
		<div class="cssloader">
