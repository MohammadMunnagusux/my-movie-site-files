 ...
 * @access public
 */
class Entertainment_Media_Customize_Section_Pro extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'entertainment-media';
		...
		<li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }} cannot-expand">
			<h3 class="accordion-section-title">
				...
				<# if ( data.bundle_text && data.bundle_url ) { #>
					<a href="{{ data.bundle_url }}" class="button button-primary" target="_blank">{{ data.bundle_text }}</a>
				<# } #>
