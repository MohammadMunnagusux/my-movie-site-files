		...
		$manager->add_section(
			new Entertainment_Media_Customize_Section_Pro(
				...
				array(
		            ...
		            'pro_url'     => esc_url( ENTERTAINMENT_MEDIA_BUY_NOW ),
		            'bundle_text' => esc_html__( 'Get All Themes In Single Pack', 'entertainment-media' ),
		            'bundle_url'  => esc_url( ENTERTAINMENT_MEDIA_THEME_BUNDLE ),
					'priority'    => 1,
				)
			)
		);
